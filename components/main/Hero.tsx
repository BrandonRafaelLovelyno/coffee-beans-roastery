  ...
  return (
    <div className="relative flex items-center justify-center w-full min-h-screen overflow-clip">
      ...
      <div className="absolute w-full h-full top-0 left-0 -z-[10]">
        <div className="relative w-full h-full">
          <MyPict
            ...
            heightPtg=""
            className={
              "absolute top-0 left-0 h-full duration-[1000ms] transition-transform " +
      ...
      <div className="flex flex-col items-center w-full h-full jusitfy-center">
        <p
          className={
            "text-[#F3F3F1] text-[8vw]/[7vw] 2xl:text-[123px]/[108px] " +
        ...
        <p
          className={
            "text-[#C9C7A7] text-[6vw]/[5vw] 2xl:text-[92px]/[77px] " +
            canvas_black.className
          }
        >
          {"Coffee Roastery"}
        ...
        <p
          className={
            "text-[#F3F3F1] mt-[3vh] text-[2vw]/[1vw] 2xl:text-[31px]/[15px] " +
            raleway.className
          }
        >
          {"See More"}
        ...
        <IoIosArrowDown
          className="text-[#F3F3F1] text-[4vw]/[3vw] 2xl:text-[61px]/[46px] hover:cursor-pointer "
          onClick={() => {
            handleClick();
          }}
        />
